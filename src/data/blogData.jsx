...
export const posts = [
  ...
  // ── POST 1: PILLAR ──────────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'AI Search Optimization for Clinics in Thailand',
  ...
  // ── POST 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          Some of it, yes. Adding FAQ content and writing treatment-specific pages are tasks a clinic manager or content writer can handle. Schema markup and technical audit work typically requires expertise to implement correctly — the kind of work <Link to="/geo/" style={s.ilink}>we handle for you</Link>. If you'd rather not navigate it alone, <Link to="/geo/ai-visibility-audit/" style={s.ilink}>request a free AI audit</Link> — we'll show you exactly where you stand and what to prioritize.
        </p>
      </div>
    ),
  },
  ...
  // ── POST 3 ──────────────────────────────────────────────────────────────────
  {
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          For a guide on how to structure content for specific clinic types, see our pages on <Link to="/industries/physiotherapy-clinics/" style={s.ilink}>marketing for physiotherapy clinics</Link> and <Link to="/industries/dental-clinics/" style={s.ilink}>dental clinics</Link>, or read <Link to="/geo/" style={s.ilink}>how Locully's GEO service works</Link>.
        </p>
  ...
  // ── POST 5 ──────────────────────────────────────────────────────────────────
  {
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          If you already have a solid SEO foundation, adding GEO optimization is incremental work — schema markup, FAQ expansion, content restructuring — that pays dividends on both channels simultaneously. See <Link to="/geo/" style={s.ilink}>how GEO works</Link>.
        </p>
        <p style={s.p}>
  ...
  // ── POST 6 ──────────────────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'The AI Search Audit Every Bangkok Clinic Needs',
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          If you'd prefer a professional audit rather than running this yourself, <Link to="/geo/ai-visibility-audit/" style={s.ilink}>request a free AI visibility audit</Link> — we'll run it across 20+ queries and give you a detailed report within 48 hours. Or see <Link to="/geo/" style={s.ilink}>how our AI search visibility service</Link> turns this checklist into fixes.
        </p>
        <p style={s.p}>
  ...
  // ── POST 7 ──────────────────────────────────────────────────────────────────
  {
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          If you'd like to see how that makes a difference, start with a <Link to="/geo/ai-visibility-audit/" style={s.ilink}>free AI visibility audit</Link> — we'll benchmark your current AI presence and give you a clear picture of where you stand versus competitors.
        </p>
        <p style={s.p}>
  ...
  // ── POST 8: WHAT IS SEO ─────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'What Is SEO? The Complete 2026 Guide',
    metaDescription: 'SEO explained from the ground up: how search engines work, the three pillars, how ranking happens, and what SEO means in 2026 alongside AI search.',
  ...
  // ── POST 9: ON-PAGE SEO ──────────────────────────────────────────────────────
  {
    ...
    metaDescription: 'On-page SEO explained: title tags, headers, content depth, internal linking, featured snippets, and the E-E-A-T signals that move rankings.',
    publishDate: '2026-03-24',
    updatedDate: '2026-03-24',
    category: 'Guide',
  ...
  // ── POST 10: BACKLINKS ───────────────────────────────────────────────────────
  {
    ...
    metaDescription: 'How Google uses backlinks to measure authority, what makes a link valuable, and which link building strategies actually work in 2026.',
    publishDate: '2026-03-24',
    updatedDate: '2026-03-24',
    category: 'Guide',
    readTime: '10 min read',
  ...
  // ── POST 11: PROGRAMMATIC SEO ────────────────────────────────────────────────
  {
    ...
    metaTitle: 'Programmatic SEO: Build Pages at Scale That Rank',
    metaDescription: 'How programmatic SEO works, 12 proven playbooks, when to use it, and what separates pages that rank from thin content that gets penalised.',
    publishDate: '2026-03-24',
    updatedDate: '2026-03-24',
    category: 'Guide',
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          Yes — the pattern doesn't require technical resources. <Link to="/geo/" style={s.ilink}>A clinic with multiple treatment pages</Link> structured consistently, a service provider generating location-specific landing pages, or a consultant building use-case pages can all benefit. The scale doesn't need to be thousands of pages. Even 20–50 well-structured pages built from a consistent template is programmatic SEO in principle.
        </p>
  ...
  // ── POST: AI SEARCH STATISTICS (CITATION-MAGNET PILLAR) ──────────────────────
  {
    ...
    metaDescription: '60+ verified AI search stats for 2026: ChatGPT, Google AI Overviews, zero-click, referral traffic, and GEO citation data — every stat sourced and linked.',
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          Locully helps clinics and businesses in Thailand get found and recommended in AI search — we helped one Bangkok clinic go from zero to 38 AI-sourced paid consultations in a single month (May 2026). To see where you stand, <Link to="/geo/" style={s.ilink}>see how our AI Visibility Optimization works</Link>, <Link to="/packages" style={s.ilink}>explore our packages</Link>, or <Link to="/geo/" style={s.ilink}>start with a free AI search audit</Link>.
        </p>
        <Callout>
  ...
  // ── SPOKE: HOW AI CHOOSES SOURCES TO CITE ────────────────────────────────────
  {
    ...
    metaDescription: 'How do AI search engines choose which sources to cite? The data: brand mentions beat backlinks ~3×, and citing sources lifts visibility 30–40%.',
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          Most businesses are optimised to rank on Google and invisible inside AI answers. Locully builds the brand-mention, citability and entity signals that get clinics and businesses named in ChatGPT, Perplexity and Google AI Overviews — the same work that helped one Bangkok clinic go from zero to 38 AI-sourced paid consultations in a single month (May 2026). See how our <Link to="/geo/" style={s.ilink}>AI Visibility Optimization works</Link>, or <Link to="/geo/" style={s.ilink}>start with a free AI search audit</Link>.
        </p>
  ...
  // ── SPOKE: ZERO-CLICK SEARCH STATISTICS ──────────────────────────────────────
  {
    ...
    metaDescription: 'Zero-click search stats for 2026: ~68% of US Google searches end without a click, up from 58.5% in 2024. The verified data and what it means.',
    publishDate: '2026-06-30',
    updatedDate: '2026-06-30',
    category: 'Statistics',
    readTime: '6 min read',
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          If most searches end without a click, the win is being the answer — not just a link in a list nobody opens. Locully optimises businesses to be cited and recommended inside AI search and featured snippets. See how our <Link to="/geo/" style={s.ilink}>AI Visibility Optimization works</Link>, or <Link to="/geo/" style={s.ilink}>get a free AI search audit</Link>.
        </p>
        <Callout><strong style={s.strong}>Last updated:</strong> June 2026. Statistics are sourced from the original publishers linked throughout.</Callout>
      </div>
    ),
  ...
  // ── SPOKE: HOW MANY PEOPLE USE CHATGPT ───────────────────────────────────────
  {
    ...
    metaDescription: 'How many people use ChatGPT in 2026? 900M weekly active users, ~2.5B prompts/day, 34% of US adults (58% of under-30s). Verified user statistics.',
    publishDate: '2026-06-30',
    updatedDate: '2026-06-30',
    category: 'Statistics',
    readTime: '5 min read',
    ...
    Content: () => (
      <div>
        ...
        <p style={s.p}>
          If 900 million people a week are asking ChatGPT for recommendations, the question is whether your business is one of them. Locully optimises clinics and businesses to be found and recommended across ChatGPT, Perplexity and Google AI — work that helped one Bangkok clinic go from zero to 38 AI-sourced paid consultations in a single month (May 2026). See how our <Link to="/geo/" style={s.ilink}>AI Visibility Optimization works</Link>, or <Link to="/geo/" style={s.ilink}>get a free AI search audit</Link>.
        </p>
        <Callout><strong style={s.strong}>Last updated:</strong> June 2026. Statistics are sourced from the original publishers linked throughout.</Callout>
      </div>
    ),
